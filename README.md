...
An open-source Python toolkit for analyzing [rummy library](https://rummylibrary.com) and [rummy meet](https://rummymeetapp.com) and [all indian rummy](https://allindianrummy.com) and [all yono game](https://allyonogamestores.com), and [holy rummy](https://holyrummyapk.com), calculating scores, evaluating potential sequences and sets, and estimating bonus wagering requirements.
